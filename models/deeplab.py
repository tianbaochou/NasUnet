...
class DeepLabV3(BaseNet):
    def __init__(self, nclass, backbone, aux=True, norm_layer=nn.BatchNorm2d, **kwargs):
        super(DeepLabV3, self).__init__(nclass, backbone, aux, norm_layer=norm_layer, **kwargs)
...
def get_deeplab(dataset='pascal_voc', backbone='resnet50', pretrained=False,
    ...
    from util.datasets import datasets, VOCSegmentation, VOCAugSegmentation, ADE20KSegmentation
